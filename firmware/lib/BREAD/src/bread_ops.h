...
/*
 * Family convenience header for BREAD contracts.
 *
 * In this repo state, BREAD currently contains RLHT ops.
 * The future shared contracts repo can include multiple device ops here.
 */

#include "rlht_ops.h"
#if defined(__has_include)
#if __has_include("dcmt_ops.h")
#include "dcmt_ops.h"
#endif
#endif
