...
#include "config.h"          // configuration file for constants such as i2c address and timing, needs to be changed between devices
#include "config_hardware.h" // hardware configuration containing pin definitions, should not change between devices typically
