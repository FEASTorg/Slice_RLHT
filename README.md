<div align="center">
  ...
  <h2><a href="https://github.com/uwo-fast/Slice_RLHT"> RLHT Slice </a></h2>
  <!-- Labels: -->
  <!-- First row: -->
  ...
  <!-- Second row: -->
  <br>
  <a href="https://github.com/uwo-fast/Slice_RLHT/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/uwo-fast/Slice_RLHT" alt="License">
  </a>
  <a href="https://github.com/uwo-fast/Slice_RLHT">
    <img src="https://img.shields.io/github/repo-size/uwo-fast/Slice_RLHT" alt="Repo Size">
  </a>
  <a href="https://github.com/uwo-fast/Slice_RLHT/issues">
    <img src="https://img.shields.io/github/issues/uwo-fast/Slice_RLHT" alt="Issues">
  </a>
  <a href="https://github.com/uwo-fast/Slice_RLHT/network/members">
    <img src="https://img.shields.io/github/forks/uwo-fast/Slice_RLHT?style=social" alt="Forks">
  </a>
  <a href="https://github.com/uwo-fast/Slice_RLHT/stargazers">
    <img src="https://img.shields.io/github/stars/uwo-fast/Slice_RLHT?style=social" alt="Stars">
  </a>
  <!-- Short description: -->
  <h3>Relay Heating Element Controller Slice for BREAD.</h3>
</div>
